          ...
          <div className="hero-content">
            ...
            <div className="hero-social">
              ...
              <div className="social-logos">
                <img src="/bs.jpeg" alt="Business Standard" className="social-logo" />
                <img src="/india.png" alt="Franchise India" className="social-logo" />
                <img src="/yourstory.png" alt="YourStory" className="social-logo" />
              </div>
              
              <p className="trusted-label">TRUSTED BY</p>
              <div className="trusted-logos">
                <img src="/flipkart.jpeg"  className="trusted-logo" />
                <span className="logo-divider">|</span>
                <img src="/starthealth.jpeg"  className="trusted-logo" />
                <span className="logo-divider">|</span>
                <img src="/frankfin.png" alt="Frankfinn" className="trusted-logo" />
                <span className="logo-divider">|</span>
                <img src="/hdfc.png" alt="HDFC" className="trusted-logo" />
              </div>
            </div>
          </div>
